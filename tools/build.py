...
def church():
  ...
  <cite>&mdash;Matthew 28:19-20</cite>
</div>"""),
    ]
    people = [
...
<section class="band band--warm band--rev" id="primary-learning" aria-labelledby="primary-h">
  ...
  <div class="band__body">
    ...
    <p>Our primary education program encompasses grades 3-6, where students continue their journey of academic and personal growth. Building upon the foundational skills developed in the early years, our elementary curriculum emphasizes both academic excellence and character development.</p>
